...
func prepareResearchCommand() *cli.Command {
	return &cli.Command{
		...
		Flags: []cli.Flag{
			...
			&cli.StringFlag{Name: "workdir", Value: ".", Usage: "clean repository root"},
			&cli.StringFlag{Name: "suite", Value: "core-v2", Usage: "research suite: core-v2, research-v3, daily-low-zone-v1_1, daily-low-zone-v1_2, daily-low-zone-v1_3, rsi-mean-reversion-v1, donchian-breakout-v1, bollinger-range-reversion-v1, capitulation-reversal-v1, ema-pullback-v1, or volume-breakout-v1"},
