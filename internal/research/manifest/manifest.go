...
var bollingerRangeReversionV1StrategyCodes = map[protocolv2.StrategyCode]struct{}{
...
var volumeBreakoutV1StrategyCodes = map[protocolv2.StrategyCode]struct{}{
	"volume-breakout-long-v1": {},
}

var spotFlowPullbackV1StrategyCodes = map[protocolv2.StrategyCode]struct{}{
...
var rrTwoExitV1StrategyCodes = map[protocolv2.StrategyCode]struct{}{
	"daily-low-zone-rr2-v1": {}, "donchian-breakout-rr2-v1": {}, "ema-pullback-rr2-v1": {},
...
func ValidateBollingerRangeReversionV1StrategyCodes(strategies []Strategy) error {
...
func ValidateVolumeBreakoutV1StrategyCodes(strategies []Strategy) error {
	return validateStrategySuite("volume-breakout-v1", strategies, volumeBreakoutV1StrategyCodes)
}

func ValidateSpotFlowPullbackV1StrategyCodes(strategies []Strategy) error {
...
func ValidateRRTwoExitV1StrategyCodes(strategies []Strategy) error {
...
func ValidateSupportedStrategyCodes(strategies []Strategy) error {
	...
	if err := ValidateEMAPullbackV1StrategyCodes(strategies); err == nil {
		return nil
	}
