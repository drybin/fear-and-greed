...
func TestDonchianBreakoutV1IsolatedAdapter(t *testing.T) {
	adapters := DonchianBreakoutV1()
	require.Len(t, adapters, 1)
	require.Equal(t, DonchianBreakoutLongCode, adapters[0].Metadata().Ref.Code)
	require.Equal(t, protocolv2.StrategyVersion("v1.0.0"), adapters[0].Metadata().Ref.Version)
	require.Equal(t, protocolv2.Timeframe("4h"), adapters[0].Metadata().Timeframe)
	require.Len(t, adapters[0].Grid(), 4)
}

func TestBollingerRangeReversionV1IsolatedAdapter(t *testing.T) {
	adapters := BollingerRangeReversionV1()
	require.Len(t, adapters, 1)
	require.Equal(t, BollingerRangeReversionLongCode, adapters[0].Metadata().Ref.Code)
	require.Equal(t, protocolv2.StrategyVersion("v1.0.0"), adapters[0].Metadata().Ref.Version)
	require.Equal(t, protocolv2.Timeframe("1h"), adapters[0].Metadata().Timeframe)
	require.Len(t, adapters[0].Grid(), 4)
}

func TestCapitulationReversalV1IsolatedAdapter(t *testing.T) {
	adapters := CapitulationReversalV1()
	require.Len(t, adapters, 1)
	require.Equal(t, CapitulationReversalLongCode, adapters[0].Metadata().Ref.Code)
	require.Equal(t, protocolv2.StrategyVersion("v1.0.0"), adapters[0].Metadata().Ref.Version)
	require.Equal(t, protocolv2.Timeframe("1h"), adapters[0].Metadata().Timeframe)
	require.Len(t, adapters[0].Grid(), 4)
}
...
func TestVolumeBreakoutV1IsolatedAdapter(t *testing.T) {
	adapters := VolumeBreakoutV1()
	require.Len(t, adapters, 1)
	require.Equal(t, VolumeBreakoutLongCode, adapters[0].Metadata().Ref.Code)
	require.Equal(t, protocolv2.StrategyVersion("v1.0.0"), adapters[0].Metadata().Ref.Version)
	require.Equal(t, protocolv2.Timeframe("1h"), adapters[0].Metadata().Timeframe)
	require.Len(t, adapters[0].Grid(), 4)
}
